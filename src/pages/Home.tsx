...
const Home = () => {
	...
	const email = 'hozefarizvi52@gmail.com';
	const whatsappNumber = '+966571282906';

	const { data: githubData } = useSWR('https://api.github.com/users/HozefaRizvi', fetcher);
	...
	return (
		<div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
			<div className="text-center relative z-10 max-w-4xl mx-auto">
				...
				>
					Creating seamless digital experiences across iOS, Android, and the Web.
				</motion.p>
				...
				>
					...
					>
						...
						<motion.div
							...
							transition={{ delay: 0.8 }}
						>
							<span className="text-base sm:text-lg font-semibold">1100+</span>

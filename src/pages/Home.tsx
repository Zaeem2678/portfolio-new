...
const Home = () => {
  ...
  const email = "zaeemhussain5@gmail.com";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        >
          Creating seamless digital experiences across iOS, Android, and the
          Web.
        </motion.p>
        ...
        >
          <motion.a
            href="https://github.com/zaeem2678"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <motion.a
            href="https://www.linkedin.com/in/zaeemraja"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center group w-full"
            whileHover={{ y: -2 }}

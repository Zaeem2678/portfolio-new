...
const experiences = [
  {
    ...
    type: "Full-time",
    description: [
      "Full-Stack Development & API Integration: Led end-to-end development of dynamic web applications using ASP.NET Core, React.js, and SQL Server. Designed and implemented RESTful APIs, integrated third-party services, and developed reusable backend components to support data-driven and real-time business workflows.",
      "System Architecture & Performance: Engineered scalable server-side solutions with ASP.NET Core and Entity Framework, optimizing database queries, caching, and API performance to ensure high availability and low latency across enterprise applications.",
      "Release & Quality Engineering: Managed CI/CD pipelines using Azure DevOps and GitHub Actions, implemented unit and integration testing with xUnit and NUnit, conducted thorough code reviews, and monitored application performance and security to ensure robust, maintainable, and production-ready deployments.",
    ],
  },
  {
